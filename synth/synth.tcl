...
# User config
set ::env(DESIGN_NAME) fpu_top

# Change if needed
set ::env(VERILOG_FILES) [glob  \
        ../verilog/rtl/fpu_sp_add.sv  \
        ../verilog/rtl/fpu_sp_mul.sv  \
        ../verilog/rtl/fpu_sp_div.sv  \
        ../verilog/rtl/fpu_dp_add.sv  \
        ../verilog/rtl/fpu_dp_mul.sv  \
        ../verilog/rtl/fpu_dp_div.sv  \
        ../verilog/rtl/fpu_top.sv     \
	]
